...
namespace VNCreator
{
    ...
    public class NodeViewer : VisualElement
    {
        ...
        public NodeViewer(BaseNode _node)
        {
            ...
            VisualTreeAsset tree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Scripts/VNCreator/Editor/Graph/Node/BaseNodeTemplate.uxml");
            tree.CloneTree(this);

            styleSheets.Add(AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Scripts/VNCreator/Editor/Graph/Node/BaseNodeStyle.uss"));
